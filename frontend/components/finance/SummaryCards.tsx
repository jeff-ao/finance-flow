...
import { formatCurrency, formatCurrencyCompact } from "@/data/mockData";
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
    ...
    <TooltipProvider>
      <div className="grid grid-cols-3 gap-3">
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <div
              className="bg-expense-light rounded-lg p-3 cursor-help transition-all hover:shadow-card-hover animate-fade-in"
            ...
            >
              ...
              <p className="text-expense font-bold text-sm sm:text-base truncate">
                {formatCurrencyCompact(summary.expenses)}
              </p>
            </div>
          </TooltipTrigger>
          <TooltipContent>
            <p className="font-semibold">{formatCurrency(summary.expenses)}</p>
            <p className="text-xs text-muted-foreground mt-1">
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <div
              className="bg-balance-light rounded-lg p-3 cursor-help transition-all hover:shadow-card-hover animate-fade-in"
          ...
          <TooltipContent>
            <p className="font-semibold">{formatCurrency(summary.balance)}</p>
            <p className="text-xs text-muted-foreground mt-1">
              Diferença desse mês (lucro)
            </p>
          </TooltipContent>
        </Tooltip>
      </div>
